...
> **⚠️ Deprecated:** This document contains technical details about the udev installer implementation. For
> comprehensive Linux installation and setup instructions, see **[Linux Setup Guide](linux-setup.md)** which covers
> AppImage installation (recommended), package managers for Ubuntu/Debian/Fedora/Arch, permissions, udev rules, and
> troubleshooting.
