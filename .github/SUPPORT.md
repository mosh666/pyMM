...
- **[User Guide](../docs/user-guide.md)** - Installation, usage, and features
...
- Email: `security@pyMediaManager.example` (if configured)
- Private Security Advisory: <https://github.com/mosh666/pyMM/security/advisories/new>
