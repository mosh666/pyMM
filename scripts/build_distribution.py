...
def install_dependencies(python_dir: Path, lib_dir: Path) -> None:
    ...
    build_tools_cmd = [
        ...
        "setuptools>=61.0", "wheel", "setuptools_scm",
        "--target", str(lib_dir),
...
def main() -> None:
    ...
    if platform.system() != "Windows":
        logger.warning("Warning: This script is designed to run on Windows to build Windows embedded distributions.")
