        ...
        try:
            ...
            if device_path.startswith("/dev/"):
                ...
                try:
                    ...
                    if device.get("ID_BUS") in ["usb", "ieee1394"]:
                        return True
                    ...
                    while parent:
                        if parent.get("ID_BUS") in ["usb", "ieee1394"]:
                            return True
        ...
        try:
            ...
            if device.startswith("/dev/"):
                ...
                try:
                    ...
                    serial = (
                        udev_device.get("ID_SERIAL_SHORT")
                        or udev_device.get("ID_SERIAL")
                        or udev_device.get("ID_MODEL")
                    )
